...
bool CDlgServerItem::GetModuleInitParameter(tagGameServerInfo * pGameServerInfo, bool bAutoMode)
{
	...
	//代理信息
	lstrcpyn(m_ModuleInitParameter.GameServiceOption.szAgentGroup,pGameServerInfo->szAgentGroup,CountArray(m_ModuleInitParameter.GameServiceOption.szAgentGroup));
