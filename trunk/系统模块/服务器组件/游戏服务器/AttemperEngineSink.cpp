...
bool CAttemperEngineSink::OnEventTCPSocketLink(WORD wServiceID, INT nErrorCode)
{
	...
	if (wServiceID==NETWORK_CORRESPOND)
	{
		...
		RegisterServer.lMinTableScore=m_pGameServiceOption->lMinTableScore;
		RegisterServer.lRestrictScore=m_pGameServiceOption->lRestrictScore;
		...
		lstrcpyn(RegisterServer.szAgentGroup,m_pGameServiceOption->szAgentGroup,CountArray(RegisterServer.szAgentGroup));
