...
//屏幕限制
#define LESS_LIST_CX				220									//列表宽度
#define SPLITTER_WIDTH				0//8								//拆分宽度
...
#define IDC_SET					    102									//设置按钮
#define IDC_CLOSE					103									//关闭按钮

//控制按钮
#define IDC_CONTROL					110									//控制按钮
#define IDC_LOCK_LIST				111									//锁定按钮
#define IDC_GAME_LIST				112									//列表按钮

//控制按钮
#define IDC_EXCHANGE 			    150									//兑换按钮
#define IDC_SAFE				    151									//保险箱按钮
...
#define IDC_USERINFO_EDIT			600									//编辑控件
//////////////////////////////////////////////////////////////////////////////////
...
INT CPlatformFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_ToolTipCtrl.AddTool(&m_btSet,TEXT("系统设置"));
	...
	m_ToolTipCtrl.AddTool(&m_btNavigation[2],TEXT("礼品兑换"));
	m_ToolTipCtrl.AddTool(&m_btNavigation[3],TEXT("银行"));
...
VOID CPlatformFrame::OnBnClickedPlatform3()
{
	...
	DlgBrowser.CreateBrowserControl(TEXT("魅力兑换"),szLoveLinessLink,CSize(730,450));
}
...
VOID CPlatformFrame::OnBnClickedExchange()
{
	...
	//打开页面
	CDlgBrowser DlgBrowser;
	DlgBrowser.CreateBrowserControl(TEXT("奖牌兑换"),szExchangeLink,CSize(730,450));
