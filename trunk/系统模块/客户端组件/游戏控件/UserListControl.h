...
//默认颜色
#define COLOR_SELECT_TX				RGB(71,89,54)							//字体颜色
#define COLOR_SELECT_BK				RGB(188,170,139)					//背景颜色
#define COLOR_NORMAL_TX				RGB(0,0,0)							//字体颜色
#define COLOR_NORMAL_BK				RGB(249,239,219)					//背景颜色
...
#define COLOR_MASTER_BK				RGB(254,211,136)					//背景颜色
#define COLOR_MEMBER_TX				RGB(218,45,3)						//字体颜色
#define COLOR_MEMBER_BK				RGB(251,171,171)					//背景颜色
