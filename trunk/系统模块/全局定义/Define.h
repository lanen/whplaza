...
#define FACE_LARGE_CX					256								//大头像宽度
#define FACE_LARGE_CY					314								//大头像高度
#define FACE_USER_INFO_CX				200								//用户信息大头像宽度
#define FACE_USER_INFO_CY				188								//用户信息大头像高度
