...
#ifndef _DEBUG
const TCHAR szProduct[]=TEXT("凌云棋牌");							//产品名字
const TCHAR szPlazaClass[]=TEXT("LYGamePlaza");						//广场类名
const TCHAR szProductKey[]=TEXT("LYGamePlatform");					//产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://lygame001.com");						//记录地址
const TCHAR szLogonServer[]=TEXT("lygame001.com");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://lygame001.com");				//平台网站
#else
