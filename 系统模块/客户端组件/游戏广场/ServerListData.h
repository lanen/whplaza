...
protected:
	...
	IServerListDataSink *			m_pIPlazaViewItemSink;				//大厅接口
...
public:
	//设置接口
	VOID SetServerListDataSink(IServerListDataSink * pIServerListDataSink, IServerListDataSink *pIPlazaViewItemSink);
