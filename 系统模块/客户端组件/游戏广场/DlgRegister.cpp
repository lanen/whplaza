...
CDlgRegister::CDlgRegister() : CDialog(IDD_DLG_REGISTER)
{
	...
	//创建画刷
	m_brBrush.CreateSolidBrush(RGB(236,216,197));
...
BOOL CDlgRegister::OnInitDialog()
{
	...
	m_ChangeValidate.SetBackGroundColor(RGB(236,216,197));
	...
	m_btSelectFace.SetButtonImage(IDB_BT_SELECT_FACE,hInstance,false,false);
