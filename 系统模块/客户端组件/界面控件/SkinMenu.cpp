...
bool CSkinMenuAttribute::Initialization(CSkinRenderManager * pSkinRenderManager)
{
	...
	//边框颜色
	m_crMenuBar=RGB(117,57,22);//pSkinRenderManager->RenderColor(0.35,0.93);
	m_crSeparator=pSkinRenderManager->RenderColor(0.95,0.90);
	m_crNormalBack=RGB(227,199,137);//pSkinRenderManager->RenderColor(0.00,1.00);
	m_crSelectBack=RGB(249,239,219);//pSkinRenderManager->RenderColor(0.13,0.98);
	m_crSelectBorder=RGB(249,239,219);//pSkinRenderManager->RenderColor(0.66,0.87);
