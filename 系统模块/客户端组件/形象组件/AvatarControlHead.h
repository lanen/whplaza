...
public:
	...
	//绘画用户信息头像框架
	virtual VOID DrawFaceUserInfoFrame(CDC * pDC, INT nXPos, INT nYPos, BYTE cbFrameKind)=NULL;
...
public:
	...
	//绘画用户信息大头像
	virtual VOID DrawFaceUserInfo(CDC * pDC, INT nXPos, INT nYPos, WORD wFaceID)=NULL;
	//绘画头像
