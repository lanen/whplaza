...
{	
	...
	pDC->DrawText(TEXT("当前游戏币："),rcScore,DT_END_ELLIPSIS | DT_RIGHT | DT_WORDBREAK);
	CRect rcBank(105,105,200,120);
	pDC->DrawText(TEXT("保险柜游戏币："),rcBank,DT_END_ELLIPSIS | DT_RIGHT | DT_WORDBREAK);
